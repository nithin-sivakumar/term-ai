const options = {
  ...
  codeConstraint:
    '\nTry your best to avoid comments unless specified above. Try your best to avoid explanations unless requested above. If explanations are asked above, be beginner friendly and explain it in depth with examples.',
  terminalConstraint:
